...
$name_emp = $cli->getCliEmpresa($userId);
// Obtener el id de la empresa por su nombre
$id_emp = $empresa->getIdByNameEmpresa($name_emp);
//echo $name_emp;
//echo $id_emp;
